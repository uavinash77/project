...
@NgModule({
  ...
  declarations: [AppComponent,HeadComponent,NavComponent,FootComponent, AboutusComponent, ServiceTabComponent, LoginComponent, SignupComponent, ContactustabComponent, IdeaComponent],
